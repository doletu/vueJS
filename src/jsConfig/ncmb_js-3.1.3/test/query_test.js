...
describe("NCMB Query", function () {
  ...
  describe("オブジェクト検索", function () {
    ...
    describe("fetch", function () {
      ...
      context(
        "検索条件に合致するデータがあれば、その中の一つがオブジェクトが返り",
        function () {
          it("callback で取得できる", function (done) {
    ...
    describe("fetchById", function () {
      ...
      context(
        "指定したobjectIdのデータがあれば、オブジェクトが返り",
        function () {
          it("callback で取得できる", function (done) {
      ...
      context(
        "指定したobjectIdのデータがなければ、404エラーが返り",
        function () {
          before(function () {
            QueryTest = ncmb.DataStore("EmptyQueryTest");
          });
  ...
  describe("検索条件追加", function () {
    ...
    describe("where", function () {
      ...
      context("検索条件を指定し、データがあれば、リストが返り", function () {
        it("callback で取得できる", function (done) {
          QueryTest.where({ number: 1 }).fetchAll(function (err, objs) {
            if (err) {
              done(err);
            } else {
    ...
    describe("equalTo", function () {
      ...
      context(
        "keyの値がvalueと等しいデータを検索した結果のリストが返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.equalTo("number", 1).fetchAll(function (err, objs) {
              if (err) {
                done(err);
              } else {
                expect(objs.length).to.be.equal(1);
    ...
    describe("notEqualTo", function () {
      context(
        "keyの値がvalueと等しくないデータを検索した結果のリストが返り",
        function () {
          beforeEach(function () {
            if (ncmb.stub) {
          ...
          it("callback で取得できる", function (done) {
            QueryTest.notEqualTo("number", 2).fetchAll(function (err, objs) {
              if (err) {
                done(err);
              } else {
                expect(objs.length).to.be.equal(1);
    ...
    describe("lessThan", function () {
      context(
        "keyの値がvalueより小さいデータを検索した結果のリストが返り",
        function () {
          beforeEach(function () {
            if (ncmb.stub) {
          ...
          it("callback で取得できる", function (done) {
            QueryTest.lessThan("number", 2).fetchAll(function (err, objs) {
              if (err) {
                done(err);
              } else {
                expect(objs.length).to.be.equal(1);
    ...
    describe("lessThanOrEqualTo", function () {
      context(
        "keyの値がvalue以下のデータを検索した結果のリストが返り",
        function () {
          beforeEach(function () {
            if (ncmb.stub) {
          ...
          it("callback で取得できる", function (done) {
            QueryTest.lessThanOrEqualTo("number", 1).fetchAll(function (
              err,
              objs
            ) {
              if (err) {
          ...
          it("promise で取得できる", function (done) {
            QueryTest.lessThanOrEqualTo("number", 1)
              .fetchAll()
              .then(function (objs) {
                expect(objs.length).to.be.equal(1);
                expect(objs[0].number).to.be.equal(1);
    ...
    describe("greaterThan", function () {
      context(
        "keyの値がvalueより大きいデータを検索した結果のリストが返り",
        function () {
          beforeEach(function () {
            if (ncmb.stub) {
          ...
          it("callback で取得できる", function (done) {
            QueryTest.greaterThan("number", 1).fetchAll(function (err, objs) {
              if (err) {
                done(err);
              } else {
                expect(objs.length).to.be.equal(1);
          ...
          it("promise で取得できる", function (done) {
            QueryTest.greaterThan("number", 1)
              .fetchAll()
              .then(function (objs) {
                expect(objs.length).to.be.equal(1);
                expect(objs[0].number).to.be.equal(2);
    ...
    describe("greaterThanOrEqualTo", function () {
      context(
        "keyの値がvalue以上のデータを検索した結果のリストが返り",
        function () {
          beforeEach(function () {
            if (ncmb.stub) {
          ...
          it("callback で取得できる", function (done) {
            QueryTest.greaterThanOrEqualTo("number", 2).fetchAll(function (
              err,
              objs
            ) {
              if (err) {
          ...
          it("promise で取得できる", function (done) {
            QueryTest.greaterThanOrEqualTo("number", 2)
              .fetchAll()
              .then(function (objs) {
                expect(objs.length).to.be.equal(1);
                expect(objs[0].number).to.be.equal(2);
    ...
    describe("in", function () {
      ...
      context(
        "keyの値がvalue配列のいずれかと等しいデータを検索した結果のリストが返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.in("number", [1, 3, 4]).fetchAll(function (err, objs) {
              if (err) {
                done(err);
              } else {
                expect(objs.length).to.be.equal(1);
    ...
    describe("notIn", function () {
      ...
      context(
        "keyの値がvalue配列のいずれとも等しくないデータを検索した結果のリストが返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.notIn("number", [2, 3, 4]).fetchAll(function (err, objs) {
              if (err) {
                done(err);
              } else {
                expect(objs.length).to.be.equal(1);
    ...
    describe("exists", function () {
      ...
      context(
        "valueがtrueのとき、keyに値が存在するデータを検索した結果のリストが返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.exists("name", true).fetchAll(function (err, objs) {
              if (err) {
                done(err);
              } else {
                expect(objs.length).to.be.equal(1);
      ...
      context(
        "valueがfalseのとき、keyに値が存在しないデータを検索した結果のリストが返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.exists("name", false).fetchAll(function (err, objs) {
              if (err) {
                done(err);
              } else {
                expect(objs.length).to.be.equal(1);
      ...
      context(
        "valueがundefinedのとき、keyに値が存在するデータを検索した結果のリストが返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.exists("name").fetchAll(function (err, objs) {
              if (err) {
                done(err);
              } else {
                expect(objs.length).to.be.equal(1);
    ...
    describe("regularExpressionTo", function () {
      ...
      context(
        "keyの値がvalueの正規表現を含むデータを検索した結果のリストが返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.regularExpressionTo("regex", "regex").fetchAll(function (
              err,
              objs
            ) {
              if (err) {
          ...
          it("promise で取得できる", function (done) {
            QueryTest.regularExpressionTo("regex", "regex")
              .fetchAll()
              .then(function (objs) {
                expect(objs.length).to.be.equal(1);
                expect(objs[0].number).to.be.equal(1);
      ...
      context(
        "前方一致を指定し、データを検索した結果のリストが返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.regularExpressionTo("regex", "^for").fetchAll(function (
              err,
              objs
            ) {
              if (err) {
          ...
          it("promise で取得できる", function (done) {
            QueryTest.regularExpressionTo("regex", "^for")
              .fetchAll()
              .then(function (objs) {
                expect(objs.length).to.be.equal(1);
                expect(objs[0].number).to.be.equal(1);
      ...
      context(
        "後方一致を指定し、データを検索した結果のリストが返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.regularExpressionTo("regex", "back$").fetchAll(function (
              err,
              objs
            ) {
              if (err) {
          ...
          it("promise で取得できる", function (done) {
            QueryTest.regularExpressionTo("regex", "back$")
              .fetchAll()
              .then(function (objs) {
                expect(objs.length).to.be.equal(1);
                expect(objs[0].number).to.be.equal(2);
    ...
    describe("inArray", function () {
      ...
      context(
        "keyの値がvalue配列のいずれかを含む配列のデータを検索した結果のリストが返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.inArray("array", [1, 5, 6]).fetchAll(function (
              err,
              objs
            ) {
              if (err) {
      ...
      context(
        "検索条件を配列以外で指定でき、条件に合うデータを検索した結果のリストが返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.inArray("array", 1).fetchAll(function (err, objs) {
              if (err) {
                done(err);
              } else {
                expect(objs.length).to.be.equal(1);
    ...
    describe("notInArray", function () {
      ...
      context(
        "keyの値がvalue配列のいずれも含まない配列のデータを検索した結果のリストが返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.notInArray("array", [4, 5, 6]).fetchAll(function (
              err,
              objs
            ) {
              if (err) {
          ...
          it("promise で取得できる", function (done) {
            QueryTest.notInArray("array", [4, 5, 6])
              .fetchAll()
              .then(function (objs) {
                expect(objs.length).to.be.equal(1);
                expect(objs[0].array[0]).to.be.equal(1);
      ...
      context(
        ...
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.notInArray("array", 4).fetchAll(function (err, objs) {
              if (err) {
                done(err);
              } else {
                expect(objs.length).to.be.equal(1);
    ...
    describe("allInArray", function () {
      ...
      context(
        "keyの値がvalue配列のすべてを含む配列のデータを検索した結果のリストが返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.allInArray("array", [1, 2, 3]).fetchAll(function (
              err,
              objs
            ) {
              if (err) {
          ...
          it("promise で取得できる", function (done) {
            QueryTest.allInArray("array", [1, 2, 3])
              .fetchAll()
              .then(function (objs) {
                expect(objs.length).to.be.equal(1);
                expect(objs[0].array[0]).to.be.equal(1);
      ...
      context(
        "検索条件を配列以外で指定でき、条件に合致するデータを検索した結果のリストが返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.allInArray("array", 1).fetchAll(function (err, objs) {
              if (err) {
                done(err);
              } else {
                expect(objs.length).to.be.equal(1);
    ...
    describe("near", function () {
      ...
      context(
        "keyの値が位置情報のデータがあれば、valueの位置から近い順のリストが返り",
        function () {
          var geoPoint = null;
          beforeEach(function () {
          ...
          it("callback で取得できる", function (done) {
            QueryTest.near("location", geoPoint).fetchAll(function (err, objs) {
              if (err) {
                done(err);
              } else {
                expect(objs.length).to.be.equal(2);
          ...
          it("promise で取得できる", function (done) {
            QueryTest.near("location", geoPoint)
              .fetchAll()
              .then(function (objs) {
                expect(objs.length).to.be.equal(2);
                expect(objs[0].number).to.be.equal(1);
    ...
    describe("withinKilometers", function () {
      ...
      context(
        "keyの値が位置情報のデータがあれば、指定したKmの範囲内でvalueの位置から近い順のリストが返り",
        function () {
          var geoPoint = null;
          beforeEach(function () {
            geoPoint = new ncmb.GeoPoint(0, 0);
          ...
          it("callback で取得できる", function (done) {
            QueryTest.withinKilometers("location", geoPoint, 1000).fetchAll(
              function (err, objs) {
                if (err) {
                  done(err);
                } else {
          ...
          it("promise で取得できる", function (done) {
            QueryTest.withinKilometers("location", geoPoint, 1000)
              .fetchAll()
              .then(function (objs) {
                expect(objs.length).to.be.equal(1);
                expect(objs[0].number).to.be.equal(1);
    ...
    describe("withinMiles", function () {
      ...
      context(
        "keyの値が位置情報のデータがあれば、指定したマイルの範囲内でvalueの位置から近い順のリストが返り",
        function () {
          var geoPoint = null;
          beforeEach(function () {
            geoPoint = new ncmb.GeoPoint(0, 0);
          ...
          it("callback で取得できる", function (done) {
            QueryTest.withinMiles("location", geoPoint, 1000).fetchAll(
              function (err, objs) {
                if (err) {
                  done(err);
                } else {
          ...
          it("promise で取得できる", function (done) {
            QueryTest.withinMiles("location", geoPoint, 1000)
              .fetchAll()
              .then(function (objs) {
                expect(objs.length).to.be.equal(1);
                expect(objs[0].number).to.be.equal(1);
    ...
    describe("withinRadians", function () {
      ...
      context(
        "keyの値が位置情報のデータがあれば、指定したラジアンの範囲内でvalueの位置から近い順のリストが返り",
        function () {
          var geoPoint = null;
          beforeEach(function () {
            geoPoint = new ncmb.GeoPoint(0, 0);
          ...
          it("callback で取得できる", function (done) {
            QueryTest.withinRadians("location", geoPoint, 0.5).fetchAll(
              function (err, objs) {
                if (err) {
                  done(err);
                } else {
          ...
          it("promise で取得できる", function (done) {
            QueryTest.withinRadians("location", geoPoint, 0.5)
              .fetchAll()
              .then(function (objs) {
                expect(objs.length).to.be.equal(1);
                expect(objs[0].number).to.be.equal(1);
    ...
    describe("withinSquare", function () {
      ...
      context(
        "keyの値が指定した矩形内の位置情報のデータを検索した結果のリストが返り",
        function () {
          var swPoint = null;
          var nePoint = null;
          beforeEach(function () {
          ...
          it("callback で取得できる", function (done) {
            QueryTest.withinSquare("location", swPoint, nePoint).fetchAll(
              function (err, objs) {
                if (err) {
                  done(err);
                } else {
          ...
          it("promise で取得できる", function (done) {
            QueryTest.withinSquare("location", swPoint, nePoint)
              .fetchAll()
              .then(function (objs) {
                expect(objs.length).to.be.equal(1);
                expect(objs[0].number).to.be.equal(1);
    ...
    describe("or", function () {
      ...
      context(
        "複数の検索条件を配列で指定し、いずれかに合致するデータの検索結果が返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.or([
              QueryTest.greaterThan("number", 2),
              QueryTest.lessThan("number", 2),
      ...
      context(
        "複数回条件を指定したとき、すべての条件に合致する検索結果が返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.or([QueryTest.greaterThan("number", 2)])
      ...
      context(
        "単一条件を配列に入れずに直接追加することができ、条件に合う検索結果が返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.or([QueryTest.greaterThan("number", 2)])
              .or(QueryTest.lessThan("number", 2))
    ...
    describe("select", function () {
      ...
      context(
        "keyの値が、サブクエリの検索結果がsubkeyに持つ値のいずれかと一致するオブジェクトを検索した結果が返り",
        function () {
          beforeEach(function () {
            SubQuery = ncmb.DataStore("SubQuery");
          });
          it("callback で取得できる", function (done) {
            QueryTest.select(
              "city",
              "cityName",
              SubQuery.greaterThan("population", 10000000)
            ).fetchAll(function (err, objs) {
              if (err) {
                done(err);
              } else {
      ...
      it("Roleクラスの検索条件を指定できる", function (done) {
        try {
          QueryTest.select(
            "class",
            "classname",
            ncmb.Role.equalTo("course", "upper")
          );
          done();
        } catch (err) {
          done(err);
        ...
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.select(
              "city",
              "cityName",
              SubQuery.greaterThan("population", 10000000).limit(1).skip(1)
            ).fetchAll(function (err, objs) {
              if (err) {
                done(err);
              } else {
    ...
    describe("relatedTo", function () {
        ...
        if (!ncmb.stub) {
          ...
          QueryTest.equalTo("number", 1)
            ...
            .then(function (obj) {
              ...
              relation.add(obj);
              return baseObj.set("belongs", relation).save();
            })
            .then(function (obj) {
      ...
      context(
        "設定したオブジェクトのkeyに関連づけられているオブジェクトを検索した結果が返り",
        function () {
          before(function () {
            baseObj = new BaseClass();
          ...
          it("callback で取得できる", function (done) {
            QueryTest.relatedTo(baseObj, "belongs").fetchAll(function (
              err,
              objs
            ) {
              if (err) {
          ...
          it("promise で取得できる", function (done) {
            QueryTest.relatedTo(baseObj, "belongs")
              .fetchAll()
              .then(function (objs) {
                expect(objs.length).to.be.equal(1);
                expect(objs[0].number).to.be.equal(1);
      ...
      it("ncmb.Userの関連オブジェクトを検索できる", function (done) {
        ...
        try {
          QueryTest.relatedTo(user, "belongs");
          done();
        } catch (err) {
          done(err);
        }
      ...
      it("ncmb.Roleの関連オブジェクトを検索できる", function (done) {
        ...
        try {
          QueryTest.relatedTo(role, "belongs");
          done();
        } catch (err) {
          done(err);
        }
      ...
      it("objectがncmbオブジェクトでないときエラーが返る", function (done) {
        try {
          QueryTest.relatedTo({ name: "name" }, "belongs");
          done(new Error("失敗すべき"));
        } catch (err) {
          done();
        }
    ...
    describe("inQuery", function () {
      ...
      context(
        "サブクエリの検索結果のいずれかのポインタをkeyに持つオブジェクトを検索した結果が返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.inQuery(
              "pointer",
              SubQuery.equalTo("status", "pointed")
            ).fetchAll(function (err, objs) {
              if (err) {
                done(err);
              } else {
  ...
  describe("inQueryのSubQueryにLimit,Skip追加テスト", function () {
    ...
    context(
      "サブクエリの検索結果のいずれかのポインタをkeyに持つオブジェクトをLimit,Skip検索した結果が返り",
      function () {
        it("callback で取得できる", function (done) {
          QueryTest.inQuery(
            "pointer",
            SubQuery.equalTo("status", "pointed").limit(1).skip(1)
          ).fetchAll(function (err, objs) {
            if (err) {
              done(err);
            } else {
  ...
  describe("レスポンス加工", function () {
    ...
    describe("include", function () {
      ...
      context(
        "指定したkeyのポインタの中身を含めたオブジェクトが返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.exists("pointer", true)
              .include("pointer")
              .fetchAll(function (err, objs) {
                if (err) {
                  done(err);
    ...
    describe("count", function () {
      ...
      context("設定するとリスト共に件数が返り", function () {
        it("callback で取得できる", function (done) {
          QueryTest.count().fetchAll(function (err, objs) {
            if (err) {
              done(err);
            } else {
    ...
    describe("order", function () {
      ...
      context("指定したkeyの昇順でリストが返り", function () {
        it("callback で取得できる", function (done) {
          QueryTest.order("number").fetchAll(function (err, objs) {
            if (err) {
              done(err);
            } else {
      ...
      context("descendingフラグをtrueにすると降順でリストが返り", function () {
        it("callback で取得できる", function (done) {
          QueryTest.order("number", true).fetchAll(function (err, objs) {
            if (err) {
              done(err);
            } else {
              expect(objs.length).to.be.equal(3);
    ...
    describe("limit", function () {
      ...
      context("指定した件数だけリストが返り", function () {
        it("callback で取得できる", function (done) {
          QueryTest.limit(1).fetchAll(function (err, objs) {
            if (err) {
              done(err);
            } else {
              expect(objs.length).to.be.equal(1);
    ...
    describe("skip", function () {
      ...
      context(
        "指定した件数だけ取得開始位置を後ろにしたリストが返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.skip(1).fetchAll(function (err, objs) {
              if (err) {
                done(err);
              } else {
                expect(objs.length).to.be.equal(2);
    ...
    describe("setOperand", function () {
      ...
      context(
        "オペランドなしの検索条件でvalueにDate型がセットされたとき、検索結果のリストが返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.equalTo("date", date).fetchAll(function (err, objs) {
              if (err) {
                done(err);
              } else {
                expect(objs.length).to.be.equal(1);
      ...
      context(
        "オペランドありの検索条件でvalueにDate型がセットされたとき、検索結果のリストが返り",
        function () {
          it("callback で取得できる", function (done) {
            QueryTest.notEqualTo("date", date).fetchAll(function (err, objs) {
              if (err) {
                done(err);
              } else {
                expect(objs.length).to.be.equal(2);
          ...
          it("promise で取得できる", function (done) {
            QueryTest.notEqualTo("date", date)
              .fetchAll()
              .then(function (objs) {
                expect(objs.length).to.be.equal(2);
                expect(JSON.stringify(objs[0].date)).to.not.eql(dateString);
