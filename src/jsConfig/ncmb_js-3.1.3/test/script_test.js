...
(typeof window !== "undefined" ? describe.skip : describe)(
  ...
  function () {
    ...
    describe("文字列を返すScriptを実行し", function () {
      context("GETメソッドで実行に成功し", function (done) {
        it("callbackで取得できる", function (done) {
          ncmb.Script.exec("GET", "execGetText.js", function (err, res) {
            if (err) {
              done(err);
            } else {
        ...
        it("promiseで取得できる", function (done) {
          ncmb.Script.exec("GET", "execGetText.js")
            .then(function (res) {
              expect(res.body).to.be.text;
              expect(res.body).to.be.equal("get_text");
              done();
      ...
      context("POSTメソッドで実行に成功し", function (done) {
        it("callbackで取得できる", function (done) {
          ncmb.Script.exec("POST", "execPostText.js", function (err, res) {
            if (err) {
              done(err);
            } else {
              expect(res.body).to.be.text;
        ...
        it("promiseで取得できる", function (done) {
          ncmb.Script.exec("POST", "execPostText.js")
            .then(function (res) {
              expect(res.body).to.be.text;
              expect(res.body).to.be.equal("post_text");
              done();
      ...
      context("PUTメソッドで実行に成功し", function (done) {
        it("callbackで取得できる", function (done) {
          ncmb.Script.exec("PUT", "execPutText.js", function (err, res) {
            if (err) {
              done(err);
            } else {
              expect(res.body).to.be.text;
        ...
        it("promiseで取得できる", function (done) {
          ncmb.Script.exec("PUT", "execPutText.js")
            .then(function (res) {
              expect(res.body).to.be.text;
              expect(res.body).to.be.equal("put_text");
              done();
      ...
      context("DELETEメソッドで実行に成功し", function (done) {
        it("callbackで取得できる", function (done) {
          ncmb.Script.exec("DELETE", "execDeleteText.js", function (err, res) {
            if (err) {
              done(err);
            } else {
              expect(res.body).to.be.text;
        ...
        it("promiseで取得できる", function (done) {
          ncmb.Script.exec("DELETE", "execDeleteText.js")
            .then(function (res) {
              expect(res.body).to.be.text;
              expect(res.body).to.be.equal("delete_text");
              done();
    ...
    describe("jsonを返すScriptを実行し", function () {
      context("GETメソッドで実行に成功し", function (done) {
        it("callbackで取得できる", function (done) {
          ncmb.Script.exec("GET", "execGetJson.js", function (err, res) {
            if (err) {
              done(err);
            } else {
        ...
        it("promiseで取得できる", function (done) {
          ncmb.Script.exec("GET", "execGetJson.js")
            .then(function (res) {
              expect(res.body).to.be.json;
              expect(JSON.parse(res.body).key).to.be.equal("get_json");
              done();
      ...
      context("POSTメソッドで実行に成功し", function (done) {
        it("callbackで取得できる", function (done) {
          ncmb.Script.exec("POST", "execPostJson.js", function (err, res) {
            if (err) {
              done(err);
            } else {
              expect(res.body).to.be.json;
        ...
        it("promiseで取得できる", function (done) {
          ncmb.Script.exec("POST", "execPostJson.js")
            .then(function (res) {
              expect(res.body).to.be.json;
              expect(JSON.parse(res.body).key).to.be.equal("post_json");
              done();
      ...
      context("PUTメソッドで実行に成功し", function (done) {
        it("callbackで取得できる", function (done) {
          ncmb.Script.exec("PUT", "execPutJson.js", function (err, res) {
            if (err) {
              done(err);
            } else {
              expect(res.body).to.be.json;
        ...
        it("promiseで取得できる", function (done) {
          ncmb.Script.exec("PUT", "execPutJson.js")
            .then(function (res) {
              expect(res.body).to.be.json;
              expect(JSON.parse(res.body).key).to.be.equal("put_json");
              done();
      ...
      context("DELETEメソッドで実行に成功し", function (done) {
        it("callbackで取得できる", function (done) {
          ncmb.Script.exec("DELETE", "execDeleteJson.js", function (err, res) {
            if (err) {
              done(err);
            } else {
              expect(res.body).to.be.json;
        ...
        it("promiseで取得できる", function (done) {
          ncmb.Script.exec("DELETE", "execDeleteJson.js")
            .then(function (res) {
              expect(res.body).to.be.json;
              expect(JSON.parse(res.body).key).to.be.equal("delete_json");
              done();
    ...
    describe("headerを必要とするScriptを実行し", function () {
      context("headerを付与してGETメソッドで実行に成功し", function (done) {
        it("callbackで取得できる", function (done) {
          ncmb.Script.set({ testHeader: "testHeaderValue" }).exec(
            "GET",
            "execGetWithHeader.js",
            function (err, res) {
              if (err) {
                done(err);
              } else {
    ...
    describe("bodyを必要とするScriptを実行し", function () {
      context(
        "bodyを付与してGETメソッドで実行し InvalidRequestBodyErrorが返され",
        function (done) {
          it("callbackで取得できる", function (done) {
            ncmb.Script.data({ testData: "testDataValue" }).exec(
              "GET",
              "execGetWithData.js",
              function (err, res) {
                if (err) {
      ...
      context(
        "bodyを付与してDELETEメソッドで実行し InvalidRequestBodyErrorが返され",
        function (done) {
          it("callbackで取得できる", function (done) {
            ncmb.Script.data({ testData: "testDataValue" }).exec(
              "DELETE",
              "execDeleteWithData.js",
              function (err, res) {
                if (err) {
                  expect(err.name).to.be.equal("InvalidRequestBodyError");
                  done();
    ...
    describe("queryを必要とするScriptを実行し", function () {
      context("queryを付与してGETメソッドで実行に成功し", function (done) {
        it("callbackで取得できる", function (done) {
          ncmb.Script.query({ testQuery: "testQueryValue" }).exec(
            "GET",
            "execGetWithQuery.js",
            function (err, res) {
              if (err) {
    ...
    describe("header, body, queryを必要とするScriptを実行し", function () {
      context(
        "メソッドを複数チェインしてPOSTメソッドで実行に成功し",
        function (done) {
          it("callbackで取得できる", function (done) {
            ncmb.Script.set({ testHeader_1: "testHeaderValue_1" })
    ...
    describe("内部エラーを返すScriptを実行し", function () {
      context("GETメソッドで実行し 500エラーが返され", function (done) {
        ...
        it("promiseで取得できる", function (done) {
          ncmb.Script.exec("GET", "execGetInternalError.js")
            .then(function (res) {
              done(new Error("error が返されなければならない"));
            })
            .catch(function (err) {
      ...
      context("POSTメソッドで実行し 500エラーが返され", function (done) {
        ...
        it("promiseで取得できる", function (done) {
          ncmb.Script.exec("POST", "execPostInternalError.js")
            .then(function (res) {
              done(new Error("error が返されなければならない"));
            })
            .catch(function (err) {
      ...
      context("PUTメソッドで実行し 500エラーが返され", function (done) {
        ...
        it("promiseで取得できる", function (done) {
          ncmb.Script.exec("PUT", "execPutInternalError.js")
            .then(function (res) {
              done(new Error("error が返されなければならない"));
            })
            .catch(function (err) {
      ...
      context("DELETEメソッドで実行し 500エラーが返され", function (done) {
        ...
        it("promiseで取得できる", function (done) {
          ncmb.Script.exec("DELETE", "execDeleteInternalError.js")
            .then(function (res) {
              done(new Error("error が返されなければならない"));
            })
            .catch(function (err) {
    ...
    describe("存在しないScriptを実行し", function () {
      context("GETメソッドで実行し 404エラーが返され", function (done) {
        it("callbackで取得できる", function (done) {
          ncmb.Script.exec("GET", "execGetNotFound.js", function (err, res) {
            if (err) {
        ...
        it("promiseで取得できる", function (done) {
          ncmb.Script.exec("GET", "execGetNotFound.js")
            .then(function (res) {
              done(new Error("error が返されなければならない"));
            })
            .catch(function (err) {
      ...
      context("POSTメソッドで実行し 404エラーが返され", function (done) {
        it("callbackで取得できる", function (done) {
          ncmb.Script.exec("POST", "execPostNotFound.js", function (err, res) {
            if (err) {
              expect(err.status).to.be.equal(404);
              done();
            } else {
        ...
        it("promiseで取得できる", function (done) {
          ncmb.Script.exec("POST", "execPostNotFound.js")
            .then(function (res) {
              done(new Error("error が返されなければならない"));
            })
            .catch(function (err) {
      ...
      context("PUTメソッドで実行し 404エラーが返され", function (done) {
        it("callbackで取得できる", function (done) {
          ncmb.Script.exec("PUT", "execPutNotFound.js", function (err, res) {
            if (err) {
              expect(err.status).to.be.equal(404);
              done();
            } else {
        ...
        it("promiseで取得できる", function (done) {
          ncmb.Script.exec("PUT", "execPutNotFound.js")
            .then(function (res) {
              done(new Error("error が返されなければならない"));
            })
            .catch(function (err) {
      ...
      context("DELETEメソッドで実行し 404エラーが返され", function (done) {
        ...
        it("promiseで取得できる", function (done) {
          ncmb.Script.exec("POST", "execDeleteNotFound.js")
            .then(function (res) {
              done(new Error("error が返されなければならない"));
            })
            .catch(function (err) {
    ...
    describe("引数を渡してScript.execを実行:", function () {
      context(
        "第一引数にHTTPメソッド以外の文字列型を渡し InvalidArgumentErrorが返され",
        function (done) {
          it("callbackで取得できる", function (done) {
            ncmb.Script.exec(
              "InvalidMethod",
          ...
          it("promiseで取得できる", function (done) {
            ncmb.Script.exec("InvalidMethod", "InvalidArgument.js")
              .then(function (res) {
                done(new Error("error が返されなければならない"));
              })
              .catch(function (err) {
      ...
      context(
        "第一引数に文字列型以外を渡し InvalidArgumentErrorが返され",
        function (done) {
          it("callbackで取得できる", function (done) {
            ncmb.Script.exec(1, "InvalidArgument.js", function (err, res) {
              if (err) {
                expect(err.name).to.be.equal("InvalidArgumentError");
                done();
              } else {
          ...
          it("promiseで取得できる", function (done) {
            ncmb.Script.exec(1, "InvalidArgument.js")
              .then(function (res) {
                done(new Error("error が返されなければならない"));
              })
              .catch(function (err) {
      ...
      context(
        "第一引数に小文字でHTTPメソッドを渡し 実行に成功し",
        function (done) {
          it("callbackで取得できる", function (done) {
            ncmb.Script.exec(
              "get",
              "execGetWithLowerCase.js",
              function (err, res) {
                if (err) {
                  done(err);
                } else {
          ...
          it("promiseで取得できる", function (done) {
            ncmb.Script.exec("get", "execGetWithLowerCase.js")
              .then(function (res) {
                expect(res.body).to.be.equal("get_with_lower_case");
                done();
              })
      ...
      context(
        "第二引数に文字列型以外の値を渡し InvalidArgumentErrorが返され",
        function (done) {
          it("callbackで取得できる", function (done) {
            ncmb.Script.exec("GET", 1, function (err, res) {
              if (err) {
                expect(err.name).to.be.equal("InvalidArgumentError");
                done();
              } else {
