...
describe("NCMB DataStore", function () {
  ...
  describe("オブジェクト登録", function () {
    describe("save", function () {
      ...
      context(
        "Dateタイプをプロパティに設定したときオブジェクト保存に成功し",
        function () {
          var Food = null;
      ...
      context(
        "未保存のncmb.Dataタイプをプロパティに設定したときオブジェクト保存に成功し",
        function () {
          var Food = null;
          var Component = null;
          var food = null;
      ...
      context(
        "保存済みのncmb.Dataタイプをプロパティに設定したときオブジェクト保存に成功し",
        function () {
          var Food = null;
          var Component = null;
          var food = null;
      ...
      context(
        "未保存のncmb.Userタイプをプロパティに設定したときオブジェクト保存に成功し",
        function () {
          var Food = null;
          var food = null;
          var user = null;
      ...
      context(
        "保存済みのncmb.Userタイプをプロパティに設定したときオブジェクト保存に成功し",
        function () {
          var Food = null;
          var food = null;
          var user = null;
      ...
      context(
        "未保存のncmb.Userタイプをプロパティに設定したとき、登録に必要なプロパティが足りなければオブジェクト保存に失敗し",
        function () {
          var Food = null;
          var food = null;
          var user = null;
  ...
  describe("オブジェクト更新", function () {
    ...
    context("リレーションを含むレコードの場合update成功", function () {
      ...
      beforeEach(function () {
        ...
        food = new Food({
          key: "value_new",
          relation: { __type: "Relation", className: "TestJS" },
        });
      });
