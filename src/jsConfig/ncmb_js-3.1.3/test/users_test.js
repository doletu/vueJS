...
describe("NCMB Users", function () {
  ...
  describe("ID/PWユーザでログイン", function () {
    ...
    describe("login", function () {
      context(
        "If the property has userName, password with special character: !$()*;",
        function () {
          beforeEach(function () {
            userName = "test";
  ...
  describe("ID/PWユーザでログイン", function () {
    ...
    describe("login", function () {
      context(
        "プロパティにuserName, passwordがあればログインに成功して",
        function () {
          beforeEach(function () {
            userName = "name";
            password = "passwd";
      ...
      context(
        "プロパティにsessionTokenがあれば自分自身を返却して",
        function () {
          beforeEach(function () {
    ...
    describe("User.login", function () {
      ...
      context("userName, password でログインした場合", function () {
        context(
          "userName, passwordが存在すればログインに成功して",
          function () {
            beforeEach(function () {
              userName = "name";
              password = "passwd";
  ...
  (typeof window !== "undefined" ? describe.skip : describe)(
    ...
    function () {
      ...
      context("facebookアカウントで登録に成功した場合", function () {
        beforeEach(function () {
          ...
          providerData = {
            id: "100002415159782",
            access_token:
              "CAACEdEose0cBAMHWz6HxQSeXJexFhxmfC3rUswuC4G5rcKiTnzdNIRZBJnmnbjVxSAbAZBP6MXKy6gTuPZBVmUEUJ6TgdwY4sCoNNZCIuXJb4EbrJvAPrAvi1KmHXbkiArmC1pro30Eqdbt94YnNz5WsvlAeYKZCZC0ApDuKJpg41ykMuhAO6kvsudbiFkMjNRotp0yLGf1AZDZD",
            expiration_date: {
              __type: "Date",
        ...
        it("promise でレスポンスを取得できる", function (done) {
          user
            .signUpWith(provider, providerData)
            .then(function (data) {
              expect(data).to.have.property("objectId", "ilxN1s7foH2X4b5h");
              done();
            })
      ...
      context("googleアカウントで登録に成功した場合", function () {
        beforeEach(function () {
          ...
          providerData = {
            ...
            access_token:
              "ya29.bAoBfwXmAnEqIVVICriUsrV1BDC1BHJJj1G0-CaasIYvKs-_zFBRvnVYQ4n3NC6bFkNIYbw6vf1eXM",
          };
          provider = "google";
        });
        it("callback でレスポンスを取得できる", function (done) {
      ...
      context(
        "authDataプロパティを直接設定した場合ログインに成功して",
        function () {
          beforeEach(function () {
            providerData = {
              id: "342304547393343184783",
      ...
      context("失敗した理由が", function () {
        ...
        context("User.linkWith", function () {
          ...
          it("promise linkWith apple id", function (done) {
            user
              .linkWith(provider, providerData)
              .then(function (data) {
                expect(data).to.have.property(
                  "sessionToken",
                  "h6dx5pQIwc0jEDt1oTtPjemPe"
  ...
  (typeof window !== "undefined" ? describe.skip : describe)(
    ...
    function () {
      ...
      describe("loginWith", function () {
        context(
          "provider, providerDataを入力した場合facebookログインに成功して",
          function () {
            beforeEach(function () {
              provider = "facebook";
              providerData = {
            ...
            it("promise でレスポンスを取得できる", function (done) {
              user
                .loginWith(provider, providerData)
                .then(function (data) {
                  expect(data).to.have.property(
                    "sessionToken",
                    "h6dx5pQIwc0jEDt1oTtPjemPe"
        ...
        context(
          "provider, providerDataを入力した場合twitterログインに成功して",
          function () {
            beforeEach(function () {
              provider = "twitter";
              providerData = {
                ...
                consumer_secret: "ubFWbG0wL7bub7gnWSkAKAmXj6VZ97DpmK2ZSCc5Opk",
                oauth_token:
                  "887423106-VxW8foViKjNDOyCLcC0WhTIyxUo2r3eXLLeogUtB",
                oauth_token_secret: "gye4VHfEHHBCH34cEJGiAWlukGAEJ6DCixYNU6Mg",
              };
              user = new ncmb.User();
            });
        ...
        context(
          "provider, providerDataを入力した場合googleログインに成功して",
          function () {
            beforeEach(function () {
              provider = "google";
              providerData = {
        ...
        context(
          "provider, providerDataを入力した場合appleログインに成功して",
          function () {
            beforeEach(function () {
              provider = "apple";
              providerData = {
        ...
        context(
          "authDataプロパティにfacebookの認証情報があればログインに成功して",
          function () {
            beforeEach(function () {
              provider = "facebook";
              providerData = {
        ...
        context(
          "authDataプロパティにtwitterの認証情報があればログインに成功して",
          function () {
            beforeEach(function () {
              provider = "twitter";
              providerData = {
        ...
        context(
          "authDataプロパティにgoogleの認証情報があればログインに成功して",
          function () {
            beforeEach(function () {
              provider = "google";
              providerData = {
        ...
        context(
          "authDataプロパティにappleの認証情報があればログインに成功して",
          function () {
            beforeEach(function () {
              provider = "apple";
              providerData = {
        ...
        context(
          "authDataプロパティに複数の認証情報があれば、指定したproviderでログインに成功して",
          function () {
        ...
        context(
          "authDataプロパティと<provider, providerData>入力の両方があれば、入力の認証情報でログインに成功して",
          function () {
            ...
            it("promise でレスポンスを取得できる", function (done) {
              user
                .loginWith(inputProvider, inputProviderData)
                .then(function (data) {
                  expect(data).to.have.property(
                    "sessionToken",
                    "bfHuZvZ9vXZaCfMZ7fBrRnvru"
        ...
        context(
          "authDataプロパティと<provider, providerData>入力の両方があるが、authDataの中にない情報でログインすると失敗して",
          function () {
            var inputProvider = null;
            var inputProviderData = null;
            beforeEach(function () {
        ...
        context(
          "authDataプロパティと<provider, providerData>入力の両方があるが、authDataの中に指摘した情報がない場合ログインすると失敗して",
          function () {
            var inputProvider = null;
            var inputProviderData = null;
            beforeEach(function () {
        ...
        context("失敗した理由が", function () {
          ...
          context(
            "facebookログインでproviderDataが不正だった場合",
            function () {
              beforeEach(function () {
                provider = "facebook";
                providerData = {
          ...
          context(
            "facebookログインでauthDataプロパティのproviderDataが不正だった場合",
            function () {
              beforeEach(function () {
                provider = "facebook";
                providerData = {
          ...
          context(
            "twitterログインでauthDataプロパティのproviderDataが不正だった場合",
            function () {
              beforeEach(function () {
                provider = "twitter";
                providerData = {
                  ...
                  oauth_consumer_key: "ZoL16IzyCEEik4nNTEN9RW",
                  consumer_secret:
                    "ubFWbG0wL7bub7gnWSkAKAmXj6VZ97DpmK2ZSCc5Opk",
                  oauth_token:
                    "887423106-VxW8foViKjNDOyCLcC0WhTIyxUo2r3eXLLeogUtB",
                };
                user = new ncmb.User();
          ...
          context(
            "googleログインでauthDataプロパティのproviderDataが不正だった場合",
            function () {
              beforeEach(function () {
                provider = "google";
                providerData = {
          ...
          context(
            "appleログインでauthDataプロパティのproviderDataが不正だった場合",
            function () {
              beforeEach(function () {
                provider = "apple";
                providerData = {
          ...
          context(
            "authDataプロパティに複数の認証情報があり、providerが指定されなかった場合",
            function () {
              var secondProvider = null;
              var secondProviderData = null;
              beforeEach(function () {
      ...
      describe("User.loginWith", function () {
        context("Userのインスタンスでログインした場合", function () {
          ...
          context("失敗した理由が", function () {
            context(
              "authDataプロパティのproviderが不正だった場合",
              function () {
                beforeEach(function () {
                  provider = "Ncmb";
                  providerData = {
        ...
        context("provider, providerDateでログインした場合", function () {
              ...
              it("callback でレスポンスを取得できる", function (done) {
                ncmb.User.loginWith(
                  ...
                  function (err, data) {
                    ...
                    expect(currentUser).to.have.property(
                      "objectId",
                      "ilxN1s7foH2X4b5h"
                    );
                    expect(currentUser).to.have.property(
          ...
          context("失敗した理由が", function () {
            ...
            context(
              "twitterログインでproviderDataが不正だった場合",
              function () {
                beforeEach(function () {
                  provider = "twitter";
                  providerData = {
            ...
            context(
              "googleログインでproviderDataが不正だった場合",
              function () {
                beforeEach(function () {
                  provider = "google";
                  providerData = {
  ...
  describe("匿名ユーザでログイン", function () {
    ...
    describe("loginAsAnonymous", function () {
      ...
      context(
        "プロパティにanonymousのauthDataがあればログインに成功して",
        function () {
          beforeEach(function () {
            authData = {
              anonymous: { id: "3dc72085-911b-4798-9707-d69e879a6185" },
            };
      ...
      context("失敗した理由が", function () {
        ...
        context("anonymous以外のauthDataログインと競合した場合", function () {
          beforeEach(function () {
            authData = {
              facebook: { id: "3dc72085-911b-4798-9707-d69e879a6185" },
            };
            user = new ncmb.User({ authData: authData });
          });
          it("callback でログインエラーを取得できる", function (done) {
  ...
  (typeof window !== "undefined" ? describe.skip : describe)(
    ...
    function () {
      ...
      describe("loginWithMailAddress", function () {
        context(
          "プロパティにmailAddress, passwordがあればログインに成功して",
          function () {
            beforeEach(function () {
      ...
      describe("User.loginWithMailAddress", function () {
        ...
        context("mailAddress, password でログインした場合", function () {
          context(
            "mailAddress, passwordが存在すればログインに成功して",
            function () {
              beforeEach(function () {
                mailAddress = "mail@example.com";
                password = "passwd";
  ...
  describe("カレントユーザ確認", function () {
    ...
    describe("getCurrentUser", function () {
        ...
        it("存在すれば取得に成功する", function (done) {
          ...
          ncmb.User.login(user, function (err, data) {
            try {
              ...
              expect(ncmb.User.getCurrentUser().userName).to.be.eql(
                currentName
              );
              done();
            } catch (err) {
      ...
      context(
        "非ログイン状態でローカルにcurrentUser情報が保存されているとき、",
        function () {
      ...
      it("取得したカレントユーザが不正なJSONの場合エラーが返る", function (done) {
        var localStorage = new require("node-localstorage").LocalStorage(
          "./scratch"
        );
  ...
  describe("ユーザ情報更新", function () {
    ...
    context("mailAddressを保持したインスタンスを更新した場合", function () {
      ...
      context(
        "mailAddressをsetし直さなければbodyに含めずにリクエストして",
        function () {
          it("callback でレスポンスを取得できる", function (done) {
            user.set("updatefield", "updated").update(function (err, data) {
              if (err) {
                done(err);
              } else {
                expect(data.updateDate).to.exist;
      ...
      context(
        "mailAddressをsetし直したらbodyに含めてリクエストして",
        function () {
          it("callback でレスポンスを取得できる", function (done) {
            user
              .set("mailAddress", "test@example.com")
  ...
  describe("ユーザーログアウト", function () {
    ...
    context("logout", function () {
      context(
        "currentUserでログアウトした場合、currentUser情報ごとインスタンスのログイン情報の削除に成功し、",
        function () {
          var user = null;
          beforeEach(function () {
            user = new ncmb.User({ userName: "name", password: "passwd" });
      ...
      context(
        "currentUserでないログイン中のユーザでログアウトした場合、インスタンスのログイン情報のみ削除に成功し、",
        function () {
          var user = null;
          var currentuser = null;
  ...
  describe("メールアドレス更新フラグのリセット", function () {
    ...
    context("mailAddressを保持したインスタンスを更新した場合", function () {
      ...
      context(
        "一度メールアドレスをsetすると以降updateのたびに更新がかかっていなくて",
        function () {
          it("callback でレスポンスを取得できる", function (done) {
            user
              .set("mailAddress", "test@example.com")
                  ...
                  user
                    ...
                    .update(function (err, data) {
                      if (err) {
                        ...
                        expect(data.updateDate).to.equal(
                          "2013-08-28T12:21:17.087Z"
                        );
                        done();
                      }
                    });
          ...
          try {
            ...
            ncmb.User.fetchById(user.objectId)
              ...
              .catch(function (err) {
                ...
                expect(err.error).eql(
                  "Authentication error by header incorrect"
                );
                done();
              });
          } catch (err) {
    ...
    context("Current User", function () {
      it("fetch currentUser after login", function (done) {
        ...
        ncmb.User.login(user, function (err, data) {
          try {
            expect(data).to.be.an.instanceof(ncmb.User);
            expect(ncmb.User.getCurrentUser().objectId).to.be.eql(
              "dummyCurrentUserId"
            );
            expect(ncmb.User.getCurrentUser().userName).to.be.eql(currentName);
            expect(ncmb.User.getCurrentUser().sessionToken).to.be.eql(
              "dummySessionToken"
            );
            user = ncmb.User.getCurrentUser();
          ...
          try {
            ...
            user
              ...
              .then(function (data) {
                ...
                expect(ncmb.User.getCurrentUser()).to.have.property(
                  "updatefield"
                );
                expect(ncmb.User.getCurrentUser().updatefield).to.be.eql(
                  "updated"
                );
                done();
              })
          ...
          try {
            ...
            name_user
              ...
              .then(function (data) {
                ...
                expect(ncmb.User.getCurrentUser()).to.not.have.property(
                  "updatefield"
                );
                done();
              })
