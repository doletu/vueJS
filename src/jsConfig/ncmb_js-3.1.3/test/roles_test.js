    ...
    describe("addUser", function () {
      ...
      context("追加するユーザを指定して登録した結果を取得し、", function () {
        it("callback で取得できる", function (done) {
          ...
          role.addUser(user).save(function (err, obj) {
            if (err) {
              done(err);
            } else {
              expect(obj.objectId).to.exist;
              add_user_id = obj.objectId;
              ncmb.User.relatedTo(obj, "belongUser")
                .fetchAll()
                .then(function (obj) {
        ...
        it("promise で取得できる", function (done) {
          ...
          role
            ...
            .then(function (obj) {
              expect(obj.objectId).to.exist;
              return ncmb.User.relatedTo(obj, "belongUser").fetchAll();
            })
            .then(function (obj) {
              expect(obj.length).to.be.eql(1);
              expect(obj[0].userName).to.be.eql(user.userName);
      ...
      context(
        ...
        function () {
          it("callback で取得できる", function (done) {
            ...
            role.addUser([user, user2]).save(function (err, obj) {
              if (err) {
                done(err);
              } else {
                expect(obj.objectId).to.exist;
    ...
    describe("addRole", function () {
      ...
      context("追加するロールを指定して登録した結果を取得し、", function () {
        it("callback で取得できる", function (done) {
          ...
          role.addRole(subrole).save(function (err, obj) {
            if (err) {
              done(err);
            } else {
              expect(obj.objectId).to.exist;
              add_role_id = obj.objectId;
              ncmb.Role.relatedTo(obj, "belongRole")
                .fetchAll()
                .then(function (obj) {
                  expect(obj.length).to.be.eql(1);
        ...
        it("promise で取得できる", function (done) {
          ...
          role
            ...
            .then(function (obj) {
              expect(obj.objectId).to.exist;
              return ncmb.Role.relatedTo(obj, "belongRole").fetchAll();
            })
            .then(function (obj) {
              expect(obj.length).to.be.eql(1);
              expect(obj[0].roleName).to.be.eql(subrole.roleName);
      ...
      context(
        ...
        function () {
          it("callback で取得できる", function (done) {
            ...
            role.addRole([subrole, subrole2]).save(function (err, obj) {
              if (err) {
                done(err);
              } else {
                expect(obj.objectId).to.exist;
      ...
      context("削除するユーザを指定して更新した結果を取得し、", function () {
        ...
        it("callback で取得できる", function (done) {
          ...
          role
            ...
            .save()
            .then(function (obj) {
              obj.removeUser(user).update(function (err, obj) {
                if (err) {
                  done(err);
                } else {
                  expect(obj.updateDate).to.exist;
        ...
        function () {
          ...
          it("callback で取得できる", function (done) {
            ...
            role
              ...
              .save()
              .then(function (obj) {
                obj.removeUser([user, user2]).update(function (err, obj) {
                  if (err) {
                    done(err);
                  } else {
                    expect(obj.updateDate).to.exist;
        ...
        function () {
          ...
          it("promise で取得できる", function (done) {
            ...
            role
              ...
              .save()
              .then(function (obj) {
                obj.removeUser(user).removeUser(user2);
                return obj.update();
              })
              .then(function (obj) {
                expect(obj.updateDate).to.exist;
      ...
      context("削除するロールを指定して更新した結果を取得し、", function () {
        ...
        it("callback で取得できる", function (done) {
          ...
          role
            ...
            .save()
            .then(function (obj) {
              obj.removeRole(subrole).update(function (err, obj) {
                if (err) {
                  done(err);
                } else {
                  expect(obj.updateDate).to.exist;
        ...
        function () {
          ...
          it("callback で取得できる", function (done) {
            ...
            role
              ...
              .save()
              .then(function (obj) {
                obj.removeRole([subrole, subrole2]).update(function (err, obj) {
                  if (err) {
                    done(err);
                  } else {
                    expect(obj.updateDate).to.exist;
        ...
        function () {
          ...
          it("promise で取得できる", function (done) {
            ...
            role
              ...
              .save()
              .then(function (obj) {
                obj.removeRole(subrole).removeRole(subrole2);
                return obj.update();
              })
              .then(function (obj) {
                expect(obj.updateDate).to.exist;
