...
var DataStore = (module.exports = (function () {
  function DataStore(name) {
    ...
    var reserved = ["save", "update", "delete", "className"];
    ...
    var Data = (function () {
      ...
      Data.prototype.update = function (callback) {
        if (!this.objectId) {
          return (callback || Promise.reject.bind(Promise))(
            new Errors.NoObjectIdError("Save the object before updating")
          );
        }
        var dataToUpdate = {};
        Object.keys(this).forEach(
      ...
      Data.prototype.delete = function (callback) {
        if (!this.objectId) {
          return (callback || Promise.reject.bind(Promise))(
            new Errors.NoObjectIdError("Save the object before deleting")
          );
        }
        return ncmb
          .request({
