...
var File = (module.exports = function (ncmb) {
  ...
  File.upload = function (fileName, fileData, acl, callback) {
    ...
    if (!fileName) {
      return (callback || Promise.reject.bind(Promise))(
        new Errors.NoFileNameError()
      );
    }
    if (!fileData) {
      return (callback || Promise.reject.bind(Promise))(
        new Errors.NoFileDataError()
      );
    }
  ...
  File.download = function (fileName, responseType, callback) {
    ...
    if (typeof fileName !== "string") {
      return (callback || Promise.reject.bind(Promise))(
        new Errors.InvalidArgumentError("File name must be string.")
      );
    }
    if (responseType && typeof responseType !== "string") {
      return (callback || Promise.reject.bind(Promise))(
        new Errors.InvalidArgumentError("Response type must be string.")
      );
    }
  ...
  File.updateACL = function (fileName, acl, callback) {
    ...
    if (!acl) {
      return (callback || Promise.reject.bind(Promise))(
        new Errors.NoACLError("Acl is required.")
      );
    }
    return ncmb
      .request({
