...
module.exports = {
  ...
  NotImplementedProviderValidationError: createError(
    "NotImplementedProviderValidationError"
  ),
  DifferentClassError: createError("DifferentClassError"),
  NoFilePathError: createError("NoFilePathError"),
  InvalidRequestHeaderError: createError("InvalidRequestHeaderError"),
  InvalidRequestBodyError: createError("InvalidRequestBodyError"),
  InvalidRequestQueryError: createError("InvalidRequestQueryError"),
};
