...
var Script = (module.exports = function (ncmb) {
  ...
  var unreplaceable = ["_id"];

  var className = (Script.className = "/script");

  Script.reservedHeaders = [
    "host",
  ...
  var Executable = (function () {
    ...
    Executable.prototype.set = function (header) {
      if (typeof header !== "object") {
        throw new Errors.InvalidRequestHeaderError(
          "Script.set requires key-value Object in argument."
        );
      }
      Script.reservedHeaders.forEach(function (key) {
        if (header[key])
          throw new Errors.InvalidRequestHeaderError(
            key + " is reserved header."
          );
      });
    ...
    Executable.prototype.data = function (data) {
      if (typeof data !== "object") {
        throw new Errors.InvalidRequestBodyError(
          "Script.data requires key-value Object in argument."
        );
      }
    ...
    Executable.prototype.query = function (query) {
      if (typeof query !== "object") {
        throw new Errors.InvalidRequestQueryError(
          "Script.query requires key-value Object in argument."
        );
      }
    ...
    Executable.prototype.exec = function (method, scriptName, callback) {
      if (typeof method !== "string") {
        return (callback || Promise.reject.bind(Promise))(
          new Errors.InvalidArgumentError(
            "Script.exec requires String HTTP method in first argument."
          )
        );
      }
      ...
      switch (method.toUpperCase()) {
        ...
        case "DELETE":
          if (this._data)
            return (callback || Promise.reject.bind(Promise))(
              new Errors.InvalidRequestBodyError(
                method + " could not have request body."
              )
            );
          break;
        case "POST":
      ...
      if (typeof scriptName !== "string") {
        return (callback || Promise.reject.bind(Promise))(
          new Errors.InvalidArgumentError("Script name must be string.")
        );
      }
  ...
  Object.keys(Executable.prototype).forEach(function (methodName) {
    Script[methodName] = function () {
      ...
      return executable[methodName].apply(
        executable,
